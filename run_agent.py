#!/usr/bin/env python3
"""
Standalone runner for Operations Agent
...
async def main():
    parser = argparse.ArgumentParser(description='Run Operations Agent')
    ...
    print("⚙️ Starting Operations Agent...")
    ...
    if args.interactive:
        ...
        print("💡 Try asking about: efficiency metrics, cost optimization, supply chain")
        while True:
            try:
                query = input("\nYou: ").strip()
                ...
                print(f"\n⚙️ Operations Agent: {response['response']}")
